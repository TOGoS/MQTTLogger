...
builder.targets = {
	...
	"run-unit-tests": {
		isFile: false,
		prereqs: ["target/cjs"],
		invoke: (ctx) => ctx.builder.doCmd("find target/cjs -iname \"*test.js\" | xargs -n 1 node")
	},
	"run-unit-tests-verbosely": {
		isFile: false,
		prereqs: ["target/cjs"],
		invoke: (ctx) => ctx.builder.doCmd("find target/cjs -iname \"*test.js\" | xargs -n 1 -I\"{}\" node \"{}\" -v")
	},
	"js-libs": {
		isFile: false,
